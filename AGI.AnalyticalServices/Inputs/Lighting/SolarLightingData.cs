...
namespace AGI.AnalyticalServices.Inputs.Lighting
{
    ...
    public class SolarLightingData<T> where T: IVerifiable
    {
        ...
        /// <see cref="Routing.PointToPointRouteData"/> or a <see cref="SiteData"/>. The start and stop times
        /// of the path dictate the analysis start and stop times when Path is a 
        /// <see cref="Routing.PointToPointRouteData"/>. If Path is set to a <see cref="Site"/>, both
